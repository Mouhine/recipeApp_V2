...
const Banner = ({ cuisine }: { cuisine: string }) => {
  return (
    <div className=" relative max-w-5xl bg-Banner_bg bg-no-repeat bg-center grid  place-content-center overflow-hidden bg-cover min-h-[500px] rounded-xl  my-6 p-4   mx-auto ">
